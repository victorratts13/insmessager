...
<h2 style="font:Arial, Helvetica, sans-serif;">Crie sua conta</h2>
<?php $link = "core/new_user.php"; include($link); ?>
Se você tiver uma conta, efetue <a href="auth.php">login</a>
</center>
